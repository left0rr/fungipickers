                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mx-auto">
                            <form action="{{route('admin.positives.update',$positive->id)}}" method="post"
                                ...
                                <div class="mb-3">
                                    ...
                                    >
                                        ...
                                        @foreach ($mushrooms as $mushroom)
                                            <option
                                                value="{{$mushroom->id}}"
                                                @selected(old('mushroom_id',$positive->mushroom_id) == $mushroom->id)
                                ...
                                <div class="mb-3">
                                    ...
                                    >{{old('description',$positive->description)}}</textarea>
                                    @error('description')
                                    <div class="invalid-feedback">
                                        <strong>
                                            {{ $message }}

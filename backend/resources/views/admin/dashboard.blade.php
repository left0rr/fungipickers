                ...
                <div class="row ">
                        ...
                        <div class="card dashboard_card l-bg-blue-dark">
                            <div class="card-statistic-3 p-4">
                                <div class="card-icon card-icon-large">
                                    <img src="{{ asset('mushroom-icon.png') }}" alt="Mushroom Icon" width="130" height="130">


                                </div>
                                <div class="mb-4">
                                    <h5 class="card-title mb-0">Mushrooms</h5>
                                </div>
                                <div class="row align-items-center mb-2 d-flex">
                                    <div class="col-8">
                                        <h2 class="d-flex align-items-center mb-0">
                                            <!-- mushrooms count here -->
                                            {{ $mushrooms->count() }}
                                        </h2>
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="card dashboard_card l-bg-orange-dark">
                            <div class="card-statistic-3 p-4">
                                <div class="card-icon card-icon-large">
                                    <img src="{{ asset('nutrients.png') }}" alt="Nutrients Icon" width="130" height="130">

                                </div>
                                <div class="mb-4">
                                    <h5 class="card-title mb-0">Nutrients</h5>
                                </div>
                                <div class="row align-items-center mb-2 d-flex">
                                    <div class="col-8">
                                        <h2 class="d-flex align-items-center mb-0">
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="card dashboard_card l-bg-green-dark">
                            <div class="card-statistic-3 p-4">
                                <div class="card-icon card-icon-large">
                                    <img src="{{ asset('recipe.png') }}" alt="Recipes Icon" width="130" height="130">
